...
In this diagram we see that the system (dashed) has moved out of the control volume and has changed shape (expanded) whilst the control volume and control surface (red) has maintained a fixed value.
